...
CREATE TABLE `ADMIN` (
    Email VARCHAR(320) NOT NULL,
    PRIMARY KEY(Email),
    CONSTRAINT ID_FK FOREIGN KEY (Email)
...
CREATE TABLE TEAM (
    ...
    ProjectID CHAR(8),
    PRIMARY KEY (ID),
    CONSTRAINT LEAD_FK FOREIGN KEY (Lead_Email)
...
CREATE TABLE BELONGS (
    ...
    CONSTRAINT TEAM_MEMBER_PK PRIMARY KEY (MEmail , Team_ID),
    CONSTRAINT MEMBER_FK FOREIGN KEY (MEmail)
        REFERENCES `MEMBER` (Email)
        ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE INVITED (
    MEmail VARCHAR(320) NOT NULL,
    EventID CHAR(10) NOT NULL,
    CONSTRAINT INVITEDPK PRIMARY KEY (MEmail , EventID),
    CONSTRAINT MEMBERFK2 FOREIGN KEY (MEmail)
        REFERENCES `MEMBER` (Email)
        ON DELETE CASCADE ON UPDATE CASCADE,
